...
class UpdateArticleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'content' => 'sometimes|required|file|mimes:txt,pdf,doc,docx|max:5120', // محتوای ارسال‌شده به‌صورت فایل (محدود به فرمت‌های خاص و اندازه)
            ...
            'img' => 'sometimes|required|image|mimes:jpeg,png,jpg|max:2048', // تصویر اجباری با فرمت و حجم مشخص
        ];
    }
}
